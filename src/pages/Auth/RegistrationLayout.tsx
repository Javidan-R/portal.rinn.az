...
export const RegistrationLayout = () => {
  ...
  const fetchData = async () => {
    try {
      const apiData = await GETAPIData("user"); 
      ...
      if (apiData.data) {
        ...
        if (existingUser) {
          ...
          if (isFormDataMatch) {
            ...
            dispatch(
              setAuthenticated({ isAuthenticated: true, role: Role.USER })
            );
  ...
  return (
    <section className="bg-[#fff] relative m-0 text-left text-[#212529]">  
      <div className={`bg-[#fff]  w-full  mx-auto min-h-[360px] relative overflow-hidden `}> 
        <div className="row h-full">
         <div className="col-12 hover-bg-black-10 p-6 lg:p-8 xl:p-10">         
            ...
            <form  className="form-horizontal form-material input-wrapper"     onSubmit={handleLogin} >
      ...
      <TEToast
        ...
        className="mb-6"
        onClose={() => setShowToast(true)} // Optional: Close toast on button click
      >
        {/* Toast content */}
