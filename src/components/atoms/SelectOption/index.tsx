  ...
  const Select: React.FC<SelectProps> = ({ name, value, onChange, onBlur, options, placeholder, className = '', width = 200 }) => {
    ...
    return (
      <div className={`relative w-${width} my-2`}>
        <div
          ...
          tabIndex={0}
        >
          <div className={value ? 'truncate' : 'text-gray-400'}>{value || placeholder}</div>
