...
const ServicesCard: FC<ServicesCardProps> = ({ image, title, name, sing ,link }) => {
  const buttonClass =
    "w-[90.8px] h-[30px] font-normal text-sm leading-none text-blue-700 bg-blue-100 rounded-md px-2 py-1 h-5";

  return (
    <div className="p-5 bg-white border border-solid border-gray-200  cursor-pointer shadow-md lg:w-[403px] lg:h-[160px]   w-full flex items-center w-full flex items-center rounded-lg">
